...
class MyWindow(QWidget):
    ...
    def initUI(self):
        ...
        # Create widget
        label = QLabel(self)
        pixmap = QPixmap(r'C:\Users\govin/Desktop/Nvn.jpeg')
    ...
    def choose_from_file_clicked(self):
        self.notificationText.setText(
            "Choosing the File... Press ESC to quit Choosing")
        self.update_notif()
        fname = QtWidgets.QFileDialog.getOpenFileName(
            self, 'Open file', 'C:/Users/govin/Desktop', 'Images (*.png, *.xmp *.jpg *.txt)')
